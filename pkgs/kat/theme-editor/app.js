class CSSParser {
  constructor() {
    ...
    this.parseRule = function (ruleText) {
      ...
      const declarationsText = parts[1] && parts[1].trim();
...
const CACHE_DIR = "Root/Enforce/cache/lib";
...
export default {
  ...
  exec: async function (Root) {
    ...
    const defaultTheme = {
      ...
      wallpaper: "https://tnm.lol/assets/wallpapers/space.png",
    };
